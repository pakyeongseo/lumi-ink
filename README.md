...
- 사용자 배포 버전: **v1.5**
- 개발 기준 빌드: **v66.34**
- 서비스 워커 캐시: `ink-memo-v1.5-v66.34-free-divider-fluid-note-link-colors`
- 상세 매뉴얼: `Lumi_Ink_Manual_1.html`
- 사용자 릴리스 노트: `Lumi_Ink_v1.5_Release_Notes.md`
- 현재 개발 변경 이력: `Lumi_Ink_v66.34_Release_Notes.md`
