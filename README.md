...
## v65.7 — v64.9 팔레트 기준 복원·두 색 사용자 지정 테마
...
루미잉크는 프로젝트 단위로 여러 종류의 메모를 관리하는 로컬 웹앱/PWA입니다. 이 배포본의 사용자 버전은 **v1.5**이며, 기능 기준 개발 빌드는 **v65.3**입니다.

## 현재 버전

- 사용자 배포 버전: **v1.5**
- 개발 기준 빌드: `v65.3`
- 서비스워커 캐시: `ink-memo-v1.5-v65.3-quickmenu-code-icons`
- 상세 매뉴얼: `Lumi_Ink_Manual_1.html`
- 최신 사용자 릴리스 노트: `Lumi_Ink_v1.5_Release_Notes.md`
- 개발 변경 이력: `Lumi_Ink_v65.3_Release_Notes.md`
...
- `Lumi_Ink_v65.3_Release_Notes.md` (최신 개발 변경 이력)
